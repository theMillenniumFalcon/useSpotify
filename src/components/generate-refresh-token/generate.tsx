...
export const Generate = () => {
  ...
  const onCopy = useCallback(() => {
    copy("https://accounts.spotify.com/en/authorize?client_id=<your_client_id>&response_type=code&redirect_uri=http%3A%2F%2Flocalhost:3000&scope=<your_desired_scope>")
  ...
  return (
    <div className="border border-white/[.1] px-1 rounded my-1">
      <code className="block whitespace-pre-wrap break-all px-3 pr-[62px] rounded text-xs md:text-sm relative cursor-copy h-auto items-center text-white" onClick={onCopy}>
            <div className="my-2">
                {"https://accounts.spotify.com/en/authorize?client_id=<your_client_id>&response_type=code&redirect_uri=http%3A%2F%2Flocalhost:3000&scope=<your_desired_scope>"}
            </div>
